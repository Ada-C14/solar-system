...
def planet_program # this is the driver method; contains the methods that build the program interface --->

  def build_cosmos # create planets & solar system --->
  ...
  def view_details_for_a_planet(solar_system)  # create a method for viewing a planet's details --->
  ...
  def add_planet(solar_system) # create a method for adding a new planet --->
  ...
  def list_menu_options # create a list of menu options to print to the user --->
  ...
  def driver_user_input_loop   # utilize above methods in a user input loop --->
    solar_system = build_cosmos
  ...
  # put it all together ---->
  return driver_user_input_loop
  end

puts planet_program # output
